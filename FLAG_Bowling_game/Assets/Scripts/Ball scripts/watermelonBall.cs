...
public class watermelonBall : bowlingBallBase
{
    public watermelonBall(float weight, float accuracy, float size, float bounce, float speed) : base(weight, accuracy, size, bounce, speed)
    {
    }
